...
if($username=="" || $password1=="" || $password2=="" || $email=="")
{
	...
	<script>
		...
		window.location="admin_signup.php";
	</script>
	<?php
}
//existing email
if(mysqli_num_rows(mysqli_query($con,"select * from admin where email='$email';"))==1)
{
	?>
	<script>
...
else
{
    ...
    $school_name=$school['school'];
     $result2= mysqli_query($con,"insert into admin (school,name,password,email) values('$school_name','$username','$password1','$email');") 
